...
(function ($) {
  ...
  $("#submitButton").on("click", function (event) {
    ...
    var result = re.test(String(email.val()).toLowerCase());
    ...
    if(!result) {
      ...
      $("#alert-msg").html("Please enter a valid email address.");
      return;
    }
    ...
    $.ajax({
      type: "POST",
      dataType: "json",
      url: "https://app.vflow.video/api/v1/queries/mailchimp",
      data: {email: email.val()},
      success: function (data) {
        $("#alert-msg").addClass("alert-msg-success");
        $("#alert-msg").removeClass("alert-msg-failure");
        $("#alert-msg").html("You have signed up successfully");
        email.val("");
        // if (data.type === "error") {
        //   $("#alert-msg").removeClass("alert-msg-success");
        //   $("#alert-msg").addClass("alert-msg-failure");
      ...
      error: function (error) {
        ...
        $("#alert-msg").removeClass("alert-msg-success");
        $("#alert-msg").addClass("alert-msg-failure");
        detail = error.responseJSON.error.detail
        if(error.status == 422) {
          $("#alert-msg").html("Email address already registered.");
        }
        else {
          $("#alert-msg").html("There is some error. Please contact support.");
        }
      },
    });
  });
